                        ...
                        <div class="col12">
                                ...
                                <form class="contact-form">
                                    <div class="row">
                                        ...
                                        <input type="password" class="pwd" name="Parola veche" value="Parola veche" onfocus="if(this.value=='Parola veche') this.value='';" onblur="if(this.value=='') this.value='Parola veche';">
                                    </div>
                                    <div class="row">
                                        <div class="par">
                                           Parola noua
